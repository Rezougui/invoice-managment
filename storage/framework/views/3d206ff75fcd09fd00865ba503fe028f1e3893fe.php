...
<?php $__env->startSection('page-header'); ?>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Facture</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/Ajouter</span>
            </div>
        </div>
            ...
            <div class="card mg-b-20">
                <div class="card-body">
                    <div class="container mt-4">
                        <form action="<?php echo e(route('facture.store')); ?>" method="post">
                            ...
                            <div class="form-row">
								<div class="form-group col-md-6">
									...
									<select class="form-control" id="paiement" name="paiement">
										<option value="" disabled selected hidden>--Sélectionner la léthode--</option>
								...
								<div class="form-group col-md-6">
									...
									<input type="number" class="form-control" id="tvaValue" value="20" disabled  name="tvaValue">
								</div>
...
<script>
    document.getElementById('tvaSwitch').addEventListener('change', function() {
        ...
        if (this.checked) {
            ...
            tvaValueField.value = '20'; // Set TVA value to 0 when checkbox is checked
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/factures/create.blade.php ENDPATH**/ ?>