...
<script src="<?php echo e(URL::asset('assets/plugins/jquery-steps/jquery.steps.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/plugins/parsleyjs/parsley.min.js')); ?>"></script>
<!--Internal  Form-wizard js -->
<script src="<?php echo e(URL::asset('assets/js/form-wizard.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/form-wizards.blade.php ENDPATH**/ ?>